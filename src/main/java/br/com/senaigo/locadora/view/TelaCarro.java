...
public class TelaCarro extends javax.swing.JInternalFrame implements FormularioPadrao {
    ...
    private void initComponents() {
        ...
        jFormattedTextFieldPlaca.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N

        jFormattedTextFieldRenavam.setForeground(new java.awt.Color(0, 0, 0));
        try {
        ...
        jFormattedTextFieldRenavam.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N

        jFormattedTextFieldAno.setForeground(new java.awt.Color(0, 0, 0));
        try {
        ...
        jFormattedTextFieldAno.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
